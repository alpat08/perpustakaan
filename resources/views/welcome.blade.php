...
@section('container')
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3" data-aos="zoom-in" data-aos="zoom-in">
                <blockquote class="blockquote text-muted">
                    ...
                    "Kesuksesan bukanlah akhir, kegagalan bukanlah fatal: yang terpenting adalah keberanian untuk terus
                    melangkah."
                </blockquote>
                <blockquote class="blockquote text-muted" data-aos="zoom-in">
    ...
    <div class="container text-center my-5">
        ...
        <p class="text-muted" data-aos="zoom-in">Jika Anda memiliki pertanyaan atau ingin berkolaborasi, jangan ragu untuk
            menghubungi saya.</p>
        <a href="mailto:contact@perpustakaan.com" data-aos="zoom-in" class="btn btn-success"><i class="bi bi-send"></i>
            Kirim Email</a>
        <div class="social-links my-3">
            <a href="https://www.facebook.com" data-aos="zoom-in" class="btn btn-primary me-2"><i
                    class="bi bi-facebook"></i> Facebook</a>
            <a href="https://www.instagram.com" data-aos="zoom-in" class="btn btn-danger me-2"><i
