<nav class="col-md-3 col-lg-2 bg-dark text-white sidebar vh-100 position-sticky">
    <div class="d-flex flex-column align-items-center pt-3 h-100">
        ...
        <ul class="nav flex-column w-100">
            ...
            <li class="nav-item"><a class="nav-link text-light" href="{{route('dashbook')}}"><i class="bi bi-search"></i> Cari Buku</a>
            </li>
            ...
            <li class="nav-item"><a class="nav-link text-light" href="#"><i class="bi bi-clock-history"></i>
                    Riwayat
                    Peminjaman</a></li>
            <li class="nav-item"><a class="nav-link text-light" href="#"><i class="bi bi-gear"></i> Pengaturan</a>
            </li>
            <li class="nav-item mt-auto"><a class="nav-link text-danger" href="#"><i class="bi bi-door-open"></i>
                    Logout</a></li>
        </ul>
    </div>
</nav>